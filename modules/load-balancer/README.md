...
| Name | Type |
|------|------|
| [aws_iam_policy.eks_lb_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| <a name="input_oidc"></a> [oidc](#input\_oidc) | OIDC url to use in role | `string` | n/a | yes |
